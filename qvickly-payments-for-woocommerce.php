<?php
/**
 * Plugin Name: Qvickly Payments for WooCommerce
 * Plugin URI: https://krokedil.com/
 * Description: Qvickly Payments for WooCommerce.
 * Author: Krokedil
 * Author URI: https://krokedil.com/
 * Version: 1.0.0
 * Text Domain: qvickly-payments-for-woocommerce
 * Domain Path: /languages
 *
 * @package qvickly-payments-for-woocommerce
 *
...
use Krokedil\Qvickly\Payments\Plugin;
...
define( 'QVICKLY_PAYMENTS_VERSION', '1.0.0' );
define( 'QVICKLY_PAYMENTS_MAIN_FILE', __FILE__ );
define( 'QVICKLY_PAYMENTS_PLUGIN_PATH', untrailingslashit( plugin_dir_path( __FILE__ ) ) );
define( 'QVICKLY_PAYMENTS_PLUGIN_URL', untrailingslashit( plugin_dir_url( __FILE__ ) ) );
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		error_log( //phpcs:ignore
			sprintf(
				...
				esc_html__( 'Your installation of the Qvickly Payments for WooCommerce Plugin is incomplete. Please run %1$s within the %2$s directory.', 'qvickly-payments-for-woocommerce' ),
				'`composer install`',
		...
		<div class="notice notice-error">
			<p>
				<?php
					printf(
						/* translators: 1: composer command. 2: plugin directory */
						esc_html__( 'Your installation of the Qvickly Payments plugin is incomplete. Please run %1$s within the %2$s directory.', 'qvickly-payments-for-woocommerce' ),
...
add_action( 'plugins_loaded', array( $qvickly, 'init' ) );

add_filter( 'plugin_action_links_' . plugin_basename( __FILE__ ), array( $qvickly, 'plugin_action_links' ) );
